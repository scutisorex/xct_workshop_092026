...
- Understand the basic structure of FMNH XCT Lab data
- Feel comfortable with navigating the 3DSlicer interface and be able to install, open, and update modules
- Be able to import and visualize 3D data
...
### September 23, 2026: 8:30am-11:45am

8:30-9:15am: Welcome, setup, introduction to 3D data types, guide to data from the FMNH XCT Lab

9:15-10:00am: Slicer basics: where are the important buttons? and how do I get my data in there? 

10:00-11:00am: Segmentation: intro and demonstration, discussion of tools

11:00-11:30am: Production of meshes

11:30-11:45am: Wrap up and discussion of additional resources
